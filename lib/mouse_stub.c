...
#define SDL_BUTTON_X3MASK   SDL_BUTTON_MASK(SDL_BUTTON_X3)
#define SDL_BUTTON_X4MASK   SDL_BUTTON_MASK(SDL_BUTTON_X4)
#define SDL_BUTTON_X5MASK   SDL_BUTTON_MASK(SDL_BUTTON_X5)
