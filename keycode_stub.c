...
#define CONS_KMOD(KMOD_Mask, Val_keymod) \
    ...
    CONS_KMOD( SDL_KMOD_LSHIFT, Val_LShift )
    CONS_KMOD( SDL_KMOD_RSHIFT, Val_RShift )
    CONS_KMOD( SDL_KMOD_LCTRL,  Val_LCtrl  )
    CONS_KMOD( SDL_KMOD_RCTRL,  Val_RCtrl  )
    CONS_KMOD( SDL_KMOD_LALT,   Val_LAlt   )
    CONS_KMOD( SDL_KMOD_RALT,   Val_RAlt   )
    CONS_KMOD( SDL_KMOD_LGUI,   Val_LGUI   )
    CONS_KMOD( SDL_KMOD_RGUI,   Val_RGUI   )
    CONS_KMOD( SDL_KMOD_NUM,    Val_NUM    )
    CONS_KMOD( SDL_KMOD_CAPS,   Val_CAPS   )
    CONS_KMOD( SDL_KMOD_MODE,   Val_MODE   )
